...
// M0001Init is the base control-plane schema (converted from goose 0001_init).
func M0001Init() *gormigrate.Migration {
	return &gormigrate.Migration{
		...
		Rollback: func(tx *gorm.DB) error {
			return tx.Exec(`DROP TABLE IF EXISTS endpoints, deployment_revisions, deployments,
				serving_template_versions, serving_templates, model_versions, models,
				tenant_quotas, api_keys, tenant_memberships, users, tenants CASCADE`).Error
		},
	}
}
