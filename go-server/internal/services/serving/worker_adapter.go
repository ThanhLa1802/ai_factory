...
func (a *WorkerAdapter) Create(ctx context.Context, d *Deployment) error { return a.validate(d) }
func (a *WorkerAdapter) Start(ctx context.Context, d *Deployment) error  { return a.validate(d) }
func (a *WorkerAdapter) Stop(ctx context.Context, d *Deployment) error   { return a.validate(d) }
func (a *WorkerAdapter) Restart(ctx context.Context, d *Deployment) error {
	return a.validate(d)
}
func (a *WorkerAdapter) Delete(ctx context.Context, d *Deployment) error { return nil }

// GetStatus reports the control-plane status back; there is no worker-side
// status to query yet.
func (a *WorkerAdapter) GetStatus(ctx context.Context, d *Deployment) (string, error) {
	return d.Status, nil
}

// HealthCheck verifies the worker's gRPC endpoint accepts TCP connections.
func (a *WorkerAdapter) HealthCheck(ctx context.Context, d *Deployment) error {
...
func (a *WorkerAdapter) validate(d *Deployment) error {
